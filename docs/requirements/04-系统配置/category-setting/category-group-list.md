...
> 版本：v3.1 | 状态：✅已完成 | 最后更新：2026-05-22
...
分类大类列表页是分类体系的入口页面，展示所有用户分类大类（CategoryGroup），支持新增、编辑、禁用/启用、删除大类。点击大类可进入该大类下的子分类列表页进行子分类管理。
