...
> 版本：v1.1 | 状态：🟡设计中 | 最后更新：2026-05-24
...
| 服饰美容 | 服饰👔、美发💇、美容💄、购物🛍️ |
| 学习成长 | 书籍📚、学习🎓 |
| 休闲娱乐 | 娱乐🎮、电影🎬、音乐🎵、游戏🎮、旅行✈️ |
| 社交关系 | 社交💬、礼物🎁、礼金🧧、亲友👨‍👩‍👧‍👦、宠物🐶 |
| 健康医疗 | 医疗💊、运动�、健身🏋️ |
| 金融理财 | 投资📈、彩票🎰 |
| 其他支出 | 其他📦、日用🧻、捐赠❤️、办公💼、通讯📱 |

> **v1.1 变更说明：**
> - 「形象与消费」→「服饰美容」，名称更聚焦
> - 「兴趣与成长」拆分为「学习成长」+「休闲娱乐」；运动、健身归入「健康医疗」
> - 「健康与医疗」→「健康医疗」
> - 「职场工作」解散，办公、通讯归入「其他支出」
> - 「其他类型」→「其他支出」
...
> **v1.1 变更说明：** 收入大类彻底独立，不再挂在支出大类下。[v1.0 中收入散落在「职场工作」「金融理财」「社交关系」「其他类型」4 个支出大类中]
> - 「职场工作」收入部分 →「薪资报酬」
> - 「金融理财」收入部分 →「投资理财」
> - 「社交关系」礼金收入 +「其他类型」其他收入 →「其他收入」
